...
\begin{itemize}[leftmargin=1.1cm]
    \item Direction: \textbf{Docteur Remplaçant Pr. V. Abitbol}
    \item Durée : 6-8 heures.
    \item Lieu : Secteur HDJ — Service de gastroentérologie et d'oncologie digestive.
    \item Ressources : médecin sénior, infirmier expert/IPA, psychologue/addictologue.
...
% ============================================================
% CODAGE & GHS — MICI (version épurée)
% ============================================================

\subsection{Codage et GHS associés — MICI}
...
>{\raggedright\arraybackslash}p{3.8cm}  % Type de séance
>{\raggedright\arraybackslash}X         % DP/DR/DAS
>{\centering\arraybackslash}p{2.6cm}    % Gradation
>{\centering\arraybackslash}p{1.6cm}    % GHM
>{\centering\arraybackslash}p{1.8cm}}   % GHS
\toprule
\rowcolor{APHPsoft}
...
Évaluation inter-cure ($\geq$4 interventions) &
...
\caption{Codage et GHM/GHS — HDJ MICI}
\end{table}
...
\subsection{Volumétrie 2024 (référence HDJ MICI)}
...
\textbf{1485} &
-- &
\textbf{\textasciitilde 662\,074~€} \\
\bottomrule
\end{tabular}

\caption{Volumétrie HDJ MICI — Détail par type de séance}
\end{table}
...
Base d’activité 2024 : \textbf{1\,485 HDJ}.  
Projection d’une croissance régulière de \textbf{+100 HDJ par an}.  
...
\begin{tabular}{lccc}
\toprule
\textbf{Année} & \textbf{Volume projeté} & \textbf{Tarif moyen} & \textbf{Recette brute estimée} \\
\midrule
Amorce & 1\,485 & 446~€ & 662\,110~€ \\
Montée en charge & 1\,585 & 446~€ & 706\,110~€ \\
Croisière & 1\,685 & 446~€ & 751\,110~€ \\
\bottomrule
\end{tabular}
\end{center}
