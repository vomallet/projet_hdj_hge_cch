...
% ============================================================
% SYNTHÈSE — CODAGE, VOLUMÉTRIE ET RECETTES (PIVOTÉE)
% ============================================================

\subsection{Synthèse codage–volumétrie–recettes}

Ventilation des 1\,346 séances 2024 selon la structure MICI (biothérapies, initiations SC, évaluations inter-cure). Capacité actuelle : 2 patients par fauteuil et par jour, 8 fauteuils, 2 jours par semaine (≈ 32 patients / semaine, hors fermetures et contraintes médicales).
...
\caption{Synthèse pivotée — Codage, volumétrie et recettes estimées (HDJ MICI)}
\end{sidewaystable}
