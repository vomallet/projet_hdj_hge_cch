% ============================================================
% HÔPITAL DE JOUR — CIRRHOSE AVANCÉE / COMPLICATIONS
% ============================================================
...
% \subsubsection[Parcours patient — HDJ cirrhose avancée]{Parcours patient — HDJ cirrhose avancée\footnotemark}
...
% ============================================================
% CODAGE & SÉANCES — HDJ CIRRHOSE AVANCÉE
% ============================================================
...
\textbf{Intervention clinique et codage principal} &
\textbf{GHM} &
\textbf{Tarif 2025} &
\textbf{Vol. 2024 / Recette} \\
\midrule

\textbf{Ponction d’ascite + albumine} &
DP : R18 \newline
...
\textbf{Fer injectable (anémie HTP)} &
DP : Z512 \newline
DR : D50.8 ou D64.9 \newline
DAS : K74.6, K76.6 &
28Z17Z &
...
\midrule
\textbf{Total activité HDJ cirrhose avancée} &
— &
— &
— &
\textbf{319 séances} \newline
...
\caption{Séances d’hôpital de jour pour cirrhose avancée : actes réalisés, codage PMSI, volumétrie et recettes observées en 2024.}
\end{table}
...
Pour les modalités techniques détaillées (ponction d’ascite, fer IV, transfusion),
voir les annexes~\ref{annexe:ponction_ascite}, \ref{annexe:fer_injectable} et \ref{annexe:transfusion_cgr}.
