...
Dans ce contexte, l’AP-HP a un rôle structurant à jouer dans l’organisation des parcours dédiés. Un HDJ addictologique intégré au sein du DMU DIGEST répond à un besoin clairement identifié : filière lisible, interventions spécialisées, continuité des soins et réduction des hospitalisations évitables. Ainsi, la structuration d’un HDJ addictologie s’inscrit pleinement dans les missions de santé publique de l’AP-HP.
...
\begin{itemize}
    \item \textbf{Annexe C.1} — Grille d’évaluation somatique–addictologique
    \item \textbf{Annexe C.2} — Grille des programmes de médiation (addictologie)
\end{itemize}
