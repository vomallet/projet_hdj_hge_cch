...
\begin{figure}[!ht]
\centering
\caption{Parcours patient — HDJ Hépatométabolique\footnotemark}
\vspace{0.8cm}
...
\footnotetext{
Activité nouvelle structurée en 2025 : montée en charge progressive prévue,
volumétrie et recettes susceptibles d’augmenter sur 2025--2027.
}
...
% --------------------------------------------------------
% TABLEAU — Traçabilité MASLD/MASH
% --------------------------------------------------------
...
\caption{Prévisions d’activité et recettes prévisionnelles }
\end{table}
