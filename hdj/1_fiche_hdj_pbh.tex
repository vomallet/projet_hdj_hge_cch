...
L’Hôpital de Jour fournit un cadre sécurisé : protocole décisionnel, guidage échographique, surveillance spécialisée, traçabilité, continuité ville–hôpital.
...
% ============================================================
% PANORAMA CODAGE + VOLUMÉTRIE 2024 (MIS À JOUR POUR V = 97)
% ============================================================
...
\caption{Panorama PBH HDJ — Codage, volumétrie et recettes (2024) — Mise à jour pour V = 97}
\end{sidewaystable}
