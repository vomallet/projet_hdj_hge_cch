...
\clearpage
% ============================================================
% CODAGE, TARIFS ET VOLUMÉTRIE — HDJ RADIOLOGIE INTERVENTIONNELLE
% ============================================================
...
\rowcolor{APHPsoft}
\textbf{Séance HDJ} &
\textbf{Indications, codage DP/DAS et CCAM} &
\textbf{GHM} &
\textbf{GHS} &
\textbf{Tarif 2025} &
\textbf{Volume 2024} &
...
\textbf{Biopsie percutanée} &
DP : Rxx.x ou Cxx.x selon organe \newline
DAS : comorbidités pertinentes \newline
...
\textbf{Drainage percutané} &
DP : K65, K83, N13 \newline
DAS : infection, douleur \newline
CCAM : HMJH006 &
07M02T &
2518 &
891~€ &
...
\textbf{Ablation thermo-induite} &
DP : C22.x, K76.x \newline
DAS : tumeurs secondaires \newline
CCAM : HLNM001 &
07K061 &
2570 &
3\,370~€ &
...
\caption{Synthèse opérationnelle — HDJ de radiologie interventionnelle : codage PMSI, volumétrie et recettes observées en 2024 (données Pr A.~Dohan).}
\end{table}
...
\midrule
01/12/2025 & Pr V.\,Mallet & 08/12/2025 \\
