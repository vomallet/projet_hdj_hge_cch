...
% ==========================================
% CHAPITRE 1 — E-SUMMARY
% ==========================================
\clearpage
\section{E-summary — Synthèse Exécutive}
...
% ============================================================
% CHAPITRE 3 — PLATEAU HDJ DIGESTIF MUTUALISÉ
% ============================================================
\clearpage
\section{Plateau des HDJ Digestifs mutualisés — Organisation Transversale}

\begin{refsection}
\input{plateau_hdj_mutualise}
\printbibliography[heading=subbibliography,title={Références}]
\end{refsection}
...
% ===============================================
% CHAPITRE 5: SOCLE MEDICAL AUX HDJ
% ===============================================
\clearpage
...
\begin{refsection}
\input{hdj/2_fiche_hdj_evalutation_cirrhoses}
\printbibliography[heading=subbibliography,title={Références}]
\end{refsection}
...
\begin{refsection}
\input{hdj/3_fiche_hdj_cirrhose_terminale}
\printbibliography[heading=subbibliography,title={Références}]
\end{refsection}
...
\begin{refsection}
\input{hdj/4_fiche_hdj_hepatometabolique}
\printbibliography[heading=subbibliography,title={Références}]
\end{refsection}
...
\begin{refsection}
\input{hdj/5_fiche_hdj_addictologie}
\printbibliography[heading=subbibliography,title={Références}]
\end{refsection}
...
\begin{refsection}
\input{hdj/7_fiche_hdj_chimiotherapies}
\printbibliography[heading=subbibliography,title={Références}]
\end{refsection}
...
\begin{refsection}
\input{hdj/8_fiche_hdj_radiologie_interventionnelle}
\printbibliography[heading=subbibliography,title={Références}]
\end{refsection}
...
\input{annexes/annexe_transfusion_sanguine}
...
\input{annexes/annexe_grille_dietetique_masld}
...
\input{annexes/annexe_grille_psy_masld}
...
\input{annexes/annexe_addicto_activites}
