...
Le plateau des HDJ digestifs mutualisé constitue un dispositif unique regroupant, sur un même site, l'ensemble des filières ambulatoires digestives et interventionnelles. Son organisation repose sur quatre principes structurants :
...
\begin{itemize}[leftmargin=1.1cm] \item \textbf{Niveau 1 (Haute technicité) :} Sectorisation en \textbf{chambres individuelles} pour l'ensemble des lits médicalisés, garantissant une confidentialité absolue et une sécurité des soins optimale.
...
\item \textbf{Niveau 3 (Flux et orientation) :} Aménagement d'\textbf{espaces lounge} avec dispositifs de rupture visuelle et acoustique. Ce niveau intègre des \textbf{box de consultation privés} et repose sur une \textbf{différenciation des flux} (patients entrants, sortants et en cours de prise en charge) pour maximiser la fluidité. L'environnement est valorisé par un apport en lumière naturelle, un mobilier contemporain et une signalétique intuitive facilitant l'orientation.
\end{itemize}
...
\midrule
1 — Lits & 6 chambres & 6–8 h & 1 patient/jour & $\sim$1\,122 séances \\
2 — Fauteuils & 6 fauteuils & 3–4 h & 2 patients/jour & $\sim$2\,244 séances \\
3 — Lounge & 4 fauteuils & 2–3 h & 3 patients/jour & $\sim$2\,2244 séances \\
\midrule
\textbf{Total} & \textbf{17 places} & — & — & \textbf{$\sim$5\,610 séances} \\
\bottomrule
\end{tabular}
...
\paragraph{Capacité annuelle —}
Avec 6 fauteuils × 220 jours × 2 patients/jour × coefficient 0.85 = \textbf{2\,244 séances/an}.

% ============================================================
% 3.4.3 NIVEAU 3 — PLATEAU AMBULATOIRE (LOUNGE)
% ============================================================
...
Il ne s'agit pas d'un espace de soins continus, mais d'un \textbf{point d'ancrage stratégique} permettant de transformer le séjour en un "One-Stop Shop" diagnostique et thérapeutique.
...
\begin{itemize}[leftmargin=1.1cm, label=\textbullet]
    ...
    \item \textbf{MICI stables :} Administration de biothérapies sous-cutanées et ETP.
...
\paragraph{Paramètres Opérationnels et Efficience —}
L'organisation est calibrée pour maximiser la rotation des actifs tout en garantissant la qualité de prise en charge :
\begin{itemize}[leftmargin=1.1cm, label=\textbullet]
    \item \textbf{Capacité :} 4 modules lounge avec isolations visuelle et acoustique.
    \item \textbf{Rotation cible :} 2 à 3 patients par fauteuil par jour.
    \item \textbf{Durée de séjour :} 2 à 3 heures par passage.
    \item \textbf{Optimisation RH :} Encadrement infirmier optimisé (1 IDE pour 4 patients), permettant de concentrer les ressources soignantes sur les niveaux de plus haute technicité.
\end{itemize}
...
L'efficience du modèle permet d'envisager les volumes suivants (base 220 jours, taux d'occupation 85\%) :
\begin{itemize}[leftmargin=1.1cm]
    \item \textbf{Hypothèse de base (2 rotations/j) :} \textbf{1\,496 séances/an}.
    \item \textbf{Cible de performance (3 rotations/j) :} \textbf{2\,244 séances/an}.
\end{itemize}
...
Vendredi & Radiologie interventionnelle (3-4) + Chimio lourde (1) & 5 lits & 1 lit \\
\bottomrule
\end{tabular}
...
Vendredi & Biothérapies & Rattrapage \\
\bottomrule
\end{tabular}
...
\begin{itemize}[leftmargin=1.1cm]
    ...
    \item \textbf{Zone niveau 3} — espace lounge aménagé (4 fauteuils, séparations).
...
\node[levelbox, below right=1.5cm and -0.5cm of accueil] (n3) {Niveau 3 \\ 4 lounge};
